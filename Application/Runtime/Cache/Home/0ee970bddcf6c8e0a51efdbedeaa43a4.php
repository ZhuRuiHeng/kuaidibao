...
<head>
  ...
  <link rel="stylesheet" href="/public/css/solution.min.css" />
</head>
<body>
  <div class="layout">
    <!-- 公共头部 -->
                  ...
                  <div data-tab-panel-0 class="am-tab-panel am-active">
                    <div class="am-g">
                      <div class="am-u-md-4 am-u-sm-6">
                        <a href="#"><img src="/public/images/solution/solution-show-1.png" alt="" /></a>
                      </div>
                      <div class="am-u-md-4 am-u-sm-6">
                        <a href="#"><img src="/public/images/solution/solution-show-2.png" alt="" /></a>
                      </div>
                      <div class="am-u-md-4 am-u-sm-6">
                        <a href="#"><img src="/public/images/solution/solution-show-3.png" alt="" /></a>
                      </div>
                      <div class="am-u-md-4 am-u-sm-6">
                        <a href="#"><img src="/public/images/solution/solution-show-4.png" alt="" /></a>
                      </div>
                      <div class="am-u-md-4 am-u-sm-6">
                        <a href="#"><img src="/public/images/solution/solution-show-5.png" alt="" /></a>
                      </div>
                      <div class="am-u-md-4 am-u-sm-6">
                        <a href="#"><img src="/public/images/solution/solution-show-6.png" alt="" /></a>
                      </div>
                    </div>
                  </div>
      ...
      <div class="container">
        ...
        <div class="o2o-container">
          <div class="am-g">
            <div class="am-u-md-4">
              <div class="o2o-box">
                <img src="/public/images/solution/o2o-img-1.png" alt="" />
            ...
            <div class="am-u-md-4">
              <div class="o2o-box">
                <img src="/public/images/solution/o2o-img-2.png" alt="" />
                <div class="o2o-content">
                  <h3>UGC内容鉴别</h3>
                  <p>安全意识很重要，要提前做好预防工作，保障系统安全。推荐使用大禹分布式防御</p>
                </div>
            ...
            <div class="am-u-md-4">
              <div class="o2o-box">
                <img src="/public/images/solution/o2o-img-3.png" alt="" />
                <div class="o2o-content">
                  <h3>处理能力</h3>
                  <p>安全意识很重要，要提前做好预防工作，保障系统安全。推荐使用大禹分布式防御</p>
                </div>
            ...
            <div class="am-tabs-bd">
                <div data-tab-panel-0 class="am-tab-panel am-active">
                  <ul class="am-avg-md-5 am-avg-sm-3 am-thumbnails">
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo1.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo2.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo3.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo4.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo5.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo6.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo7.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo8.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo9.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo10.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo11.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo12.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo13.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo14.jpg" /></a></li>
                    <li><a href="#"><img class="am-thumbnail" src="/public/images/solution/cooperation-logo15.jpg" /></a></li>
                  </ul>
                </div>
                <div data-tab-panel-1 class="am-tab-panel ">
                  <ul class="am-avg-md-5 am-avg-sm-3 am-thumbnails">
